...
* [X] Screen Capture tool
    * [X] Bottom of screen needs some status about capture.  Number of unique patterns store, number of the patterns that have ROM address recovered.  Number of palettes.  Are the pallete ROM addresses recovered?
...
* [X] Add a screenshot of the sprite editor to the main project readme page
